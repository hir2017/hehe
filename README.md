...
所有接口错误码列表：
		...
		USER_RESETPHONE_FAIL(410,"重置手机号失败"),
		...
		USER_PASSWORD_CHECKED(443,"请输入8-16位密码"),
		...
		USER_NOT_AUTH_LEVELA(41711,"认证级别不是A"),
		USER_NOT_AUTH_LEVELB(41712,"认证级别不是B"),
		USER_NOT_AUTH_LEVELC(41713,"认证级别不是C"),
		VIDEO_AUTH_MONEY_REFUSED(41731,"认证C资金不足"),
		VIDEO_UPLOAD_ERROR(41801,"认证视频上传失败"),
		VIDEO_URL_UPDATE_ERROR(41802,"视频地址更新失败"),
		//新增 二级登陆
		USER_AUTH_BY_GA(5555, "请进行谷歌认证"),
		USER_NOT_AUTH_GA(5554, "未进行谷歌认证"),
		USER_AUTH_CODE_TIMEOUT(5556, "验证码超时,请重新登录"),
		USER_AUTH_BY_PHONE(5557, "请进行手机认证"),
		USER_AUTH_BY_GA_FAIL(5558, "谷歌密码输入有误"),
		USER_AUTH_CODE_FAIL(5559, "验证码错误,请重新登录"),
		...
		VIRTUAL_TRADE_SUCCESS(580,"虚拟交易成功"),
		VIRTUAL_TRADE_FAIL(581,"虚拟交易失败"),

		DATA_NULL(10011, "数据为空");
