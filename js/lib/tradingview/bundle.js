...
function(e) {
            ...
            return new Promise(function(a, u) {
                o._requester.sendRequest(o._datafeedUrl, "history", i).then(function(e) {
                    if ("ok" === e.s || "no_data" === e.s) {
                        ...
                        if ("no_data" === e.s) r.noData = !0,
                        r.nextTime = e.nextTime;
                        else for (var s = void 0 !== e.v,
                        o = void 0 !== e.o,
                        i = 0; i < e.t.length; ++i) {
                            var n = {
                                time: 1e3 * e.t[i],
                            ...
                            o && (n.open = Number(e.o[i]), n.high = Number(e.h[i]), n.low = Number(e.l[i])),
        ...
        e.prototype._updateData = function() {
            ...
            if (! (0 < this._requestsPending)) {
                ...
                var e = function(t) {
                    ...
                    s._updateDataForSubscriber(t).then(function() {
                        r._requestsPending -= 1,
                        n("DataPulseProvider: data for #" + t + " updated successfully, pending=" + r._requestsPending)
                    }).
                    catch(function(e) {
                        r._requestsPending -= 1,
                        n("DataPulseProvider: data for #" + t + " updated with error=" + c(e) + ", pending=" + r._requestsPending)
                    })
                },
                s = this;
            ...
            if (! (0 < this._requestsPending)) {
                var e = function(t) {
                    ...
                    i._quotesProvider.getQuotes(1 === s ? r.fastSymbols: r.symbols).then(function(e) {
                        o._requestsPending--,
                        o._subscribers.hasOwnProperty(t) && (r.listener(e), n("QuotesPulseProvider: data for #" + t + " (" + s + ") updated successfully, pending=" + o._requestsPending))
                    }).
                    catch(function(e) {
                        o._requestsPending--,
                        n("QuotesPulseProvider: data for #" + t + " (" + s + ") updated with error=" + c(e) + ", pending=" + o._requestsPending)
                    })
                },
                i = this;
                for (var t in this._subscribers) e(t)
    ...
    var t = function() {
        ...
        e.prototype._init = function() {
            for (var e = this,
            t = [], r = {},
            s = 0, o = this._exchangesList; s < o.length; s++) {
                var i = o[s];
                r[i] || (r[i] = !0, t.push(this._requestExchangeData(i)))
            }
            return Promise.all(t).then(function() {
                e._symbolsList.sort(),
                n("SymbolsStorage: All exchanges data loaded")
            })
        },
        e.prototype._requestExchangeData = function(s) {
            ...
            return new Promise(function(t, r) {
                o._requester.sendRequest(o._datafeedUrl, "symbol_info", {
                    ...
                    n("SymbolsStorage: Request data for exchange '" + s + "' failed, reason=" + c(e)),
                    t()
                })
            })
        },
        e.prototype._onExchangeDataReceived = function(t, r) {
            ...
            s = 0;
            try {
                for (var o = r.symbol.length,
                i = void 0 !== r.ticker; s < o; ++s) {
                    var n = r.symbol[s],
    ...
    var o = function() {
        ...
        e.prototype.resolveSymbol = function(e, t, r) {
            ...
            if (this._configuration.supports_group_request) {
                if (null === this._symbolsStorage) throw new Error("UdfCompatibleDatafeed: inconsistent configuration (symbols storage)");
                this._symbolsStorage.resolveSymbol(e).then(o).
                catch(r)
            } else {
                var i = {
                    symbol: e
        ...
        e.prototype._requestConfiguration = function() {
            return this._send("config").
                ...
                return n("UdfCompatibleDatafeed: Cannot get datafeed configuration - use default, error=" + c(e)),
                null
            })
        },
    ...
    p = function() {
        ...
        return e.prototype.sendRequest = function(e, t, r) {
            ...
            return void 0 !== this._headers && (o.headers = this._headers),
            fetch(e + "/" + t, o).then(function(e) {
                return e.text()
            }).then(function(e) {
                return JSON.parse(e)
            })
