			...
			<div>
				<div className="rw-form">
					...
					<div className="rw-form-item">
						<Alert message={UPEX.lang.template('當前安全等级{level}可提額度(TWD)：NT${num}/日',{ level: userInfoStore.authLevel, num: `${userInfoStore.userInfo.dayLimit || 0}` })} type="warning" showIcon />
					</div>
					<div className="rw-form-item">
