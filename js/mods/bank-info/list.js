...
export default class BankList extends Component {
    ...
    render() {
        ...
        <Modal
          title={UPEX.lang.template('解绑银行卡')}
            ...
            gaBindSuccess
              ? <div className="item">
                <Input
                  ...
                  size="large" placeholder={UPEX.lang.template('请输入谷歌验证码')} />
              </div>
              : <div className="item">
                <Input
                  ...
                  size="large" placeholder={UPEX.lang.template('请输入图片验证码')} />
                <Input
                  onChange={this.vCodeChange}
                  addonAfter={<Vcodebutton imgCode={this.state.ivCode} codeid={codeid} bankAndWithdraw={true} style={{ lineHeight: 'normal', height: 'auto' }} />}
