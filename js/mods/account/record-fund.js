...
class List extends Component {
    ...
    render() {
        ...
        if (store.isFetching) {
            $content = (
                <div className="mini-tip">{UPEX.lang.template('正在加载')}</div>
            );
            ...
            <div className="account-record-list">
                <div className="table-hd">
                    <table>
                        <tbody>
                            <tr>
                                <th className="swift-no">
                                    {UPEX.lang.template('流水号')}
                                </th>
                                <th className="time">
                                    {UPEX.lang.template('日期')}
                                </th>
                                <th className="name">
                                    {UPEX.lang.template('名称')}
                                </th>
                                <th className="balance">
                                    {UPEX.lang.template('收/支')}
                                </th>
                                <th className="status">
                                    {UPEX.lang.template('状态')}
                                </th>
                                <th className="pay-method">
                                    {UPEX.lang.template('支付方式')}
                                </th>
                            </tr>
                        </tbody>
                    </table>
