...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-127502494-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-127502494-1');
</script>
 */
...
})(window, document, 'script', `https://www.googletagmanager.com/gtag/js?id=${GAdsCode}`, 'gads');


// gads('create', GAdsCode, 'auto');
// gads('send', 'pageview');

gads('js', new Date());
gads('config', GAdsCode);
