                ...
                <div className="order-body-inner coin-list">
                    <div className="order-header">
                        ...
                        <div className="type-select">
                            <Select defaultValue={this.defaultType} onChange={val => {store.setDataType(val)}}>
                               {/* <Option value="all">
                    ...
                    <div className="order-main">
                        <div className="order-main-box"><RecordList defaultType={this.defaultType}/></div>
                    </div>
                </div>
            </div>
        );
