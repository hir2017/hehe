    ...
    render() {
        ...
        if (gradeCfg.grade === 'Z') {
            ...
            switch (userInfo.isAuthPrimary) {
                // 审核中
                case 1:
                    noAuthMsg = UPEX.lang.template('身份認證資料審核中...');
                    break;
                // 驳回
                case -1:
                    noAuthMsg = UPEX.lang.template('身份認證審核失敗');
                    break;
                default:
                    noAuthMsg = UPEX.lang.template('您还未进行身份认证');
                    break;
            }
            $gradeInfo = <p className="no-auth">{noAuthMsg}</p>;
        } else {
            $gradeInfo = (
                    ...
                    <Col span={12} className="left">
                        ...
                        <Row className="bind-status">
                            <Col
                                ...
                                onClick={this.doSkip.bind(this, 'phone', userInfo.isValidatePhone)}
                            >
                            ...
                            <Col span={12} className={userInfo.isValidateEmail ? 'auth' : ''}>
                                <img
                                    ...
                                    onClick={this.doSkip.bind(this, 'mail', userInfo.isValidateEmail)}
                                />
