...
import RechargeCoinView from '@/mods/recharge-withdraw/coin-recharge-aus';
import RecordList from '@/mods/record-list/coin-recharge-record-aus';
...
class Recharge extends Component{
	...
	render() {
        ...
        return (
            <PageWrapper title={UPEX.lang.template('充币')} className="coin-recharge-aus header-shadow">
                { $content }
